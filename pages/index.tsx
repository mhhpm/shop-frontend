...
const ImgSrcTony = 'https://bizweb.dktcdn.net/thumb/1024x1024/100/381/999/products/ca-phe-cung-tony.jpg?v=1590395320940'
const ImgSrcQGKN = 'https://salt.tikicdn.com/cache/w1200/ts/product/56/1d/e1/c1e7282144fcfaf258a23bc4bf04f47a.jpg'
const ImgSrcLogist = 'https://salt.tikicdn.com/cache/w1200/ts/product/ef/50/0b/698a3607bf8cd4b7224300bd695484c0.jpg'
const ImgSrcTesla = 'https://salt.tikicdn.com/cache/400x400/ts/product/f3/81/4e/9c2baf49c9b281a7e4e46169adcb9675.jpg.webp'
const ImgSrcElon = 'https://salt.tikicdn.com/cache/400x400/ts/product/c9/94/00/aff05741dd084a2d8be80cf1f6fc338c.jpg.webp'
        ...
        <div className="row no-gutters align-items-center pt-60px">
          <div className="col-5 d-none d-sm-block">
            <div className="hero-banner__img">
              <Image className="card-img-top" loader={() => ImgSrcElon} src={'image'} alt="..." width={750} height={700}/>
            </div>
          </div>
    ...
    <div className="row">
      <div className="col-md-6 col-lg-4 mb-4 mb-lg-0">
        <div className="card card-blog">
          ...
          <Image className="card-img-top" loader={() => ImgSrcTony} src={'image'} alt="..." width={250} height={200}/>
          </div>
